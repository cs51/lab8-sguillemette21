...
let news1 = WEvent.add_listener newswire fakeNewsNetwork ;;
let news2 = WEvent.add_listener newswire buzzFake ;;
...
let _ = WEvent.remove_listener newswire news1 ;;
let _ = WEvent.remove_listener newswire news2 ;;
